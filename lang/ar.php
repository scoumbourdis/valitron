...
return array(
    ...
    'ipv4'          => "عنوان IPv4 غير صحيح",
    'ipv6'          => "عنوان IPv6 غير صحيح",
    ...
    'boolean'       => "يجب أن يكون منطقي",
    'lengthBetween' => "يجب أن يكون بين %d و %d حرف",
    'creditCard'    => "يجب أن يكون رقم بطاقة إئتمان صحيح",
    'lengthMin'     => "يجب أن يكون على الأقل %d حرف",
    'lengthMax'     => "يجب ألا يتجاوز %d حرف",
    'instanceOf'    => "يجب أن يكون نسخة من '%s'",
