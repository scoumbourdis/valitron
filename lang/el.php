...
return array(
    ...
    'ipv4'          => "δεν είναι έγκυρη διεύθυνση IPv4",
    'ipv6'          => "δεν είναι έγκυρη διεύθυνση IPv6",
    ...
    "containsUnique"=> "πρέπει να περιέχει μόνο μοναδικά στοιχεία",
    "requiredWith"  => "είναι απαραίτητο",
    "requiredWithout"=> "είναι απαραίτητο",
    "subset"        => "περιέχει στοιχείο που δεν είναι στη λίστα",
    "arrayHasKeys"  => "δεν περιέχει όλα τα απαιτούμενα κλειδιά"
);
